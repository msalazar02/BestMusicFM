    ...
    <body>
        ...
        <div class="col-md-8">
            <table class="table table-hover ">
                ...
                <c:forEach var="tempResegnas" items="${Resegna}">
                    ...
                    <c:url var="linkCargar" value="LResegnasFans">
                        <c:param name="Accion" value="Cargar"></c:param>
                        <c:param name="IdUsuario" value="${id}"></c:param>
                        <c:param name="idUsuario" value="${idU}"></c:param>
                        <c:param name="idA" value="${idA}"></c:param>
                    ...
                    <c:url var="linkEliminar" value="LResegnasFans">
                        <c:param name="IdUsuario" value="${id}"></c:param>
                        <c:param name="idUsuario" value="${idU}"></c:param>
                        <c:param name="idA" value="${idA}"></c:param>
        ...
        <div class="container" class ="col-md-3">
            ...
            <div id="Registrar" class ="col-md-3">
                ...
                <%-- -----------------------------------CANCELAR------------------------------------- --%>
                <form action="LResegnasFans" method="POST" class="form-group">
                    <input type="hidden" name="IdUsuario" value="${id}" >
                    <input type="hidden" name="idUsuario" value="${idU}">
                    <input type="hidden" name="idA" value="${idA}">
            ...
            <div id="Actualizar" class ="col-md-3">
                ...
                <form action="LUsuarios" method="POST" class="form-group">
                    <input type="hidden" name="IdUsuario" value="${id}">
                    <input type="hidden" name="Accion" value="SaberNombreF">
