        ...
        <div class="container" class ="col-md-3">
            ...
            <div id="Actualizar" class ="col-md-3">
                ...
                <form action = "LCanciones" method="post" >
                    <input type="hidden" name="idUsuario" value="${id}">
                    <input type="hidden" name="idAlbum" value="${idA}">
                    <input type="hidden" name="CodigoCancion" value="${ActualizarCancion.getIdCancion}">
                    <input type="hidden" name="Accion" value="Actualizar">


                    <div class="form-group">
                        <label for="nombre">Nombre</label>
                        <input type="text" class="form-control" value="${ActualizarCancion.getNombre()}" name="nombre" required="">
                    </div> 


                    <div class="form-group">
                        <label for="duracion">Duración</label>
                        <input type="text" class="form-control" value="${ActualizarCancion.getDuracion()}" name="duracion" required="">
                    </div> 
